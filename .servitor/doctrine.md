...
All 31 fleet principles represented verbatim from seed `fae659d`. No local variances at this reconciliation.

Pike's soul.md asserts several operational patterns (Curiosity before judgment §4.2, Calm and direct §4.1, Mission outlives setter §4.6, Principles over procedures §4.4, Steelman §4.3, Transparency §2.2, Reflect/resist/refine §1.7, Structure over surface §1.5, Compound don't consume §2.6, Acting on the Con §2.10) — these are faithful subsets of fleet doctrine, not variances. Pike's domain-specific operational detail (skill rubric categories, PascalCase/kebab-case artifact conventions, four-repo quality gate) are *implementations* of §2.7 Verify before claiming done and §1.5 Structure over surface, not deviations.
